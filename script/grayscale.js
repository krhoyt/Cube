class Cube {
  ...
  detect() {
    ...
    // [rgba, rgba, ...]
    let gray = new jsfeat.matrix_t( width, height, jsfeat.U8_t | jsfeat.C1_t );

    // Make grayscale
    jsfeat.imgproc.grayscale( raw.data, width, height, gray, jsfeat.COLOR_RGBA2GRAY );    

    // Render
    this.render( gray, raw );
  }
